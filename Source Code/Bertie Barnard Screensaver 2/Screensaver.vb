...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Screensaver))
...
#End Region
    ...
    Private Sub Loader()
        Try
            Cursor.Hide()
            AxShockwaveFlash1.Movie = (Application.StartupPath & "\Bertie Barnard Screensaver 2.swf").Replace("\\", "\")
    ...
    Private Sub Form1_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove, Button1.MouseMove
        Try
            ...
            If mousemoveaccept = True And mousemovecount = 10 Then
                Exit_Routine()
            End If
        Catch ex As Exception
            Error_Handler(ex.Message)
